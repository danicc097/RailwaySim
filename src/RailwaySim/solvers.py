...
from .data_formatter import s_to_hhmmss, effort_curve_to_arrays
    ...
    def main(window, constants, resultsFilename):
        ...
        def _create_offset_array(array, row, speed, next_speed, stacked_steps):
            ...
            while accum_steps < L_TRAIN and remaining_length > 0:
                ...
                #* When the next step is larger than the remaining length to be overwritten,
        ...
        #TODO return actual mode selected as tuple in case it's overwritten
